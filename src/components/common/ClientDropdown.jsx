    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        (isArrayWithValues(clients) &&
          isValidHttpUrl(clients[0]?.image_url)) ? (
          <Image
            src={
            ...
            alt={
              selectedClient?.name || clients[0]?.name || "Client profile image"
            }
            width={24}
            height={24}
        ...
        <span
          className="max-w-[80px] sm:max-w-[120px] md:max-w-[150px] text-[18px] font-semibold truncate leading-[28px]"
      ...
      {isOpen && !isLoading && !isError && (
        <div className="absolute top-full mt-2 right-0 w-48 sm:w-56 bg-background rounded-md shadow-xl overflow-hidden no-scrollbar z-50">
              ...
              clients.map((client) => (
                ...
                >
                  {isValidHttpUrl(client?.image_url) ? (
                    <Image
                      src={client?.image_url || "/profile.png"}
