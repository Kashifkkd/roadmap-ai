...
export const endpoints = {
  ...
  getStepImageDetails: (sessionId, chapterUid, stepUid) =>
    `api/generative-ai/v2/step-image-details?session_id=${encodeURIComponent(sessionId)}&chapter_uid=${encodeURIComponent(chapterUid)}&step_uid=${encodeURIComponent(stepUid)}`,
  regenerateSelectedImages: "api/generative-ai/v2/regenerate-selected-images",
  cancelStepImages: "api/generative-ai/v2/cancel-step-images",
  unlinkScreenAssets: "api/generative-ai/v2/unlink-screen-assets",
  unlinkAsset: "api/generative-ai/v2/unlink-asset",
